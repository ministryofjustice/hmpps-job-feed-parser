...
describe VacancyFormatter do
  before do
    stub_const('PRISONS',
      [
        { name: 'HMP/YOI Downview', town: 'Sutton', lat: 51.338463, lng: -0.188044, type: 'Youth Custody' },
        { name: 'HMP/YOI Isle of Wight', town: 'Newport', lat: 50.713196, lng: -1.3076464, type: 'Youth Custody' },
        { name: 'HMP Littlehey', town: 'Huntingdon', lat: 52.2805913, lng: -0.3122374, type: 'Prison' },
        { name: 'HMP Stocken', town: 'Oakham', lat: 52.7469327, lng: -0.5821626999999999, type: 'Prison' }
      ])
  end
