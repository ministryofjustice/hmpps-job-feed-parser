...
def write_data_to_s3
  ...
  obj = s3.bucket('hmpps-feed-parser').object(ENV['location']/'vacancies.json')
  obj.upload_file('good-data.json')
  obj = s3.bucket('hmpps-feed-parser').object(ENV['location']/'youth-custody-vacancies.json')
  obj.upload_file('good-youth-custody-data.json')
  obj = s3.bucket('hmpps-feed-parser').object(ENV['location']/'vacancies-bad-data.json')
  obj.upload_file('bad-data.json')
  obj = s3.bucket('hmpps-feed-parser').object(ENV['location']/'summary.csv')
